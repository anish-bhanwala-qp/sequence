...
var DrawSuit = /** @class */ (function () {
    function DrawSuit() {
    }
    DrawSuit.drawSpade = function (context, x, y, width, height) {
        context.save();
    ...
    DrawSuit.drawHeart = function (context, x, y, width, height) {
        context.save();
        context.beginPath();
    ...
    DrawSuit.drawClub = function (context, x, y, width, height) {
        context.save();
    ...
    DrawSuit.drawDiamond = function (context, x, y, width, height) {
        context.save();
        context.beginPath();
        context.moveTo(x, y);
        // top left edge
...
exports.default = DrawSuit;
//# sourceMappingURL=DrawSuit.js.map